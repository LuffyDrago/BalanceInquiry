    ...
    stages {
        stage('Run and Compile Code') {
            ...
            steps {
                ...
                sh "workspace/wso2am-micro-gw-toolkit-linux-3.2.0/bin/micro-gw micro-gw build BalanceInquiry --deployment-config /BalanceInquiry/conf/deployment-config.toml"
